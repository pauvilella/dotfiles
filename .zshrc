...
alias laibel-tunnel-dev='kubectl --context main -n laibel-dev port-forward pod/rds-bastion 5432:5432'
alias laibel-tunnel-prod='kubectl --context main -n laibel port-forward pod/rds-bastion 5432:5432'
